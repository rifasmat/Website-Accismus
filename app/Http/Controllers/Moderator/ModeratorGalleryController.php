...
class ModeratorGalleryController extends Controller
{
    ...
    {
        return view('moderator.gallery.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('moderator.gallery.list');
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('moderator.gallery.edit', compact('gallery'));
    }
    ...
    public function konfirmasi($uuid)
    {
        ...
        // Arahkan dan kirimkan datanya ke view
        return view('moderator.gallery.konfirmasi', compact('gallery'));
    }
    ...
    public function destroy($uuid)
    {
        ...
        return redirect()->route('moderator.gallery.list')->with('success', 'Foto Berhasil Dihapus.');
    }
}
