...
class ModeratorTeamController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        return view('moderator.team.search', compact('users', 'search', 'administratorExists'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('moderator.team.edit', compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('moderator.team.list');
    }
}
