...
class SenateHistoryController extends Controller
{
    public function index()
    {
        $history = History::orderBy('created_at', 'desc')->paginate(9); // Menampilkan 9 history rf per halaman dengan urutan terbaru
        return view('senate.history-rf.list', compact('history'));
    }


    public function create()
    {
        return view('senate.history-rf.create');
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('senate.history-rf.search', compact('history'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('senate.history-rf.list');
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('senate.history-rf.edit', compact('history'));
    }
    ...
    public function konfirmasi($uuid)
    {
        ...
        // Arahkan dan kirimkan datanya ke view
        return view('senate.history-rf.konfirmasi', compact('history'));
    }
    ...
    public function destroy($uuid)
    {
        ...
        return redirect()->route('senate.history-rf.list')->with('success', 'Foto Berhasil Dihapus.');
    }
}
