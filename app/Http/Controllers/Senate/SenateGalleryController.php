...
class SenateGalleryController extends Controller
{
    public function index()
    {
        $gallery = Gallery::orderBy('created_at', 'desc')->paginate(9); // Menampilkan 9 gallery per halaman dengan urutan terbaru
        return view('senate.gallery.list', compact('gallery'));
    }


    public function create()
    {
        return view('senate.gallery.create');
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('senate.gallery.search', compact('gallery'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('senate.gallery.list');
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('senate.gallery.edit', compact('gallery'));
    }
    ...
    public function konfirmasi($uuid)
    {
        ...
        // Arahkan dan kirimkan datanya ke view
        return view('senate.gallery.konfirmasi', compact('gallery'));
    }
    ...
    public function destroy($uuid)
    {
        ...
        return redirect()->route('senate.gallery.list')->with('success', 'Foto Berhasil Dihapus.');
    }
}
