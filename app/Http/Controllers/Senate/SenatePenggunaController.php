...
class SenatePenggunaController extends Controller
{
    ...
    public function index()
    {
        $users = User::where('role', '!=', 'Administrator')
            ...
            ->paginate(10);
        return view('senate.pengguna.list', compact('users'));
    }

    public function create()
    {
        return view('senate.pengguna.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('senate.pengguna.list');
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('senate.pengguna.edit', compact('user'));
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        return redirect()->route('senate.pengguna.list')->with('success', 'Pengguna berhasil diperbarui.');
    }
    ...
    public function konfirmasi($uuid)
    {
        ...
        // Arahkan dan kirimkan datanya ke view
        return view('senate.pengguna.konfirmasi', compact('user'));
    }
    ...
    public function destroy($uuid)
    {
        ...
        return redirect()->route('senate.pengguna.list')->with('success', 'Pengguna Berhasil Dihapus.');
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('senate.pengguna.search', compact('users', 'search', 'administratorExists'));
    }

    public function profil()
    {
        $user = Auth::user(); // menmgambil data pengguna yang sedang login
        return view('senate.profil.list', compact('user'));
    }
    ...
    public function updateProfil(Request $request, $uuid)
    {
        ...
        return redirect()->route('senate.profil.list')->with('success', 'Profil berhasil diperbarui.');
    }
}
