...
class GuildLeaderHistoryController extends Controller
{
    public function index()
    {
        $history = History::orderBy('created_at', 'desc')->paginate(9); // Menampilkan 9 history rf per halaman dengan urutan terbaru
        return view('guildleader.history-rf.list', compact('history'));
    }


    public function create()
    {
        return view('guildleader.history-rf.create');
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('guildleader.history-rf.search', compact('history'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('guildleader.history-rf.list');
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('guildleader.history-rf.edit', compact('history'));
    }
    ...
    public function konfirmasi($uuid)
    {
        ...
        // Arahkan dan kirimkan datanya ke view
        return view('guildleader.history-rf.konfirmasi', compact('history'));
    }
    ...
    public function destroy($uuid)
    {
        ...
        return redirect()->route('guildleader.history-rf.list')->with('success', 'Foto Berhasil Dihapus.');
    }
}
