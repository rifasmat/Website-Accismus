...
class GuildLeaderTeamController extends Controller
{
    public function index()
    {
        ...
        return view('guildleader.team.list', compact('users'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('guildleader.team.edit', compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('guildleader.team.list');
    }
}
