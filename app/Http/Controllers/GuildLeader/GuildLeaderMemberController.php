...
class GuildLeaderMemberController extends Controller
{
    public function index()
    {
        ...
        return view('guildleader.member.list', compact('users'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('guildleader.member.search', compact('users'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('guildleader.member.edit', compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'role.required' => 'Role member harus diisi.',
        ]);

        // Simpan data role member sebelumnya
        ...
        // Periksa apakah member mengubah role
        ...
        if ($request->hasFile('foto')) {
            ...
            // Simpan file ke direktori 'member'
    ...
    public function changeStatus($uuid)
    {
        ...
        return redirect()->route('guildleader.request-member.list')
