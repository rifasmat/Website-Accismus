...
class GuildLeaderBenefitController extends Controller
{
    public function index()
    {
        $benefit = Benefit::first();
        if ($benefit) {
            return view('guildleader.benefit.list', compact('benefit'));
        }
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        return redirect()->route('guildleader.benefit.list');
    }
}
