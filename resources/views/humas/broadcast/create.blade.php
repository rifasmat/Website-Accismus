...
<form action="{{ route('humas.broadcast.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group mt-3">
        <a href="{{ route('humas.broadcast.history') }}" class="btn btn-danger btn-sm">&nbsp; Kembali</a>
