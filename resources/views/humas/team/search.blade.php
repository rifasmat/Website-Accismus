...
<div class="container">
    <!-- Search -->
    <form action="{{ route('humas.team.search') }}" method="GET" class="form-inline mt-3">
            ...
            <tr class="text-center">
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('humas.team.edit', $user->uuid) }}" class="btn btn-warning btn-sm mr-1">Edit</a>
                    </div>
                </td>
            </tr>
            @endforeach
