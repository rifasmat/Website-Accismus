    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('member.team.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Team -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('member.history-rf.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End History RF -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('member.gallery.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Gallery -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('member.member.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Member -->
