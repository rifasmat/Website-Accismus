...
<div class="container">
    <!-- Search -->
    <form action="{{ route('senate.member.search') }}" method="GET" class="form-inline mt-3">
        <div class="input-group">
            ...
            <div class="input-group-append">
                ...
                <a href="{{ route('senate.member.list') }}">
            ...
            <tr class="text-center">
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('senate.member.edit', $user->uuid) }}" class="btn btn-warning btn-sm mr-1">Edit</a>
                        <form method="GET" action="{{ route('senate.member.konfirmasi', $user->uuid) }}" style="display:inline;">
