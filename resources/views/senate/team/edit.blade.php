...
<div class="container">
    <form action="{{ route('senate.team.update', $user->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mt-3">
            <a href="{{ route('senate.team.list') }}" class="btn btn-danger btn-sm">&nbsp; Kembali</a>
