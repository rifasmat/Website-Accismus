...
<div class="container">
    <!-- Search -->
    <form action="{{ route('senate.team.search') }}" method="GET" class="form-inline mt-3">
    ...
    <table class="table mt-3">
        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td>
                    @if($user->uuid !== Auth::user()->uuid && !in_array($user->role, ['Administrator', 'Guild Leader', 'Humas']))
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('senate.team.edit', $user->uuid) }}" class="btn btn-warning btn-sm mr-1">Edit</a>
                    </div>
                    @endif
                </td>
            </tr>
