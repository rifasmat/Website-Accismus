    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-10 col-lg-8">
          <div>
            <h1>Accismus Community</h1>
            <div><span>
                <h1>RF Online Private Server</h1>
              </span></div>
          </div>
          <h2>Sekarang Sedang Berada Di RF Euforia</h2>
        </div>
      </div>

      <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
        <div class="col-xl-2 col-md-4">
          <div class="icon-box" id="instagram-icon">
            <i class="ri-instagram-line"></i>
            <h3><a href="" target="_blank">Instagram</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box" id="discord-icon">
            <i class="ri-discord-line"></i>
            <h3><a href="" target="_blank">Discord</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box" id="whatsapp-icon">
  ...
  <main id="main">
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="public/assets/home/img/clients/client-1.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="public/assets/home/img/clients/client-2.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="public/assets/home/img/clients/client-3.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="public/assets/home/img/clients/client-4.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="public/assets/home/img/clients/client-5.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="public/assets/home/img/clients/client-6.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="public/assets/home/img/clients/client-7.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="public/assets/home/img/clients/client-8.png" class="img-fluid" alt=""></div>
          </div>
    ...
    <section id="features" class="features">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="image col-lg-6" style='background-image: url("public/assets/home/img/features.jpg");' data-aos="fade-right"></div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <img src="public/assets/home/img/team/team-1.jpg" class="img-fluid" alt="">
                <div class="social">
