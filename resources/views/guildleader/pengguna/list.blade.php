...
<div class="box-header d-flex justify-content-end mb-3">
    <div class="btn-group">
        <a href="{{ route('guildleader.pengguna.create') }}" class="btn btn-secondary">
...
<div class="container">
    <div class="mb-2">
        <!-- Search -->
        <form action="{{ route('guildleader.pengguna.search') }}" method="GET" class="form-inline mt-3">
        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td>
                    ...
                    <form method="GET" action="{{ route('guildleader.pengguna.konfirmasi', $user->uuid) }}" style="display:inline;">
                        @csrf
