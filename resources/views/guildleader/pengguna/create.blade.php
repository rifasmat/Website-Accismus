...
<form action="{{ route('guildleader.pengguna.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group mt-3">
        ...
        <select id="role" name="role" class="form-control">
            ...
            <option value="Guild Leader" {{ old('role') == 'Guild Leader' ? 'selected' : '' }}>Guild Leader</option>
    ...
    <div class="form-group mt-3">
        <a href="{{ route('guildleader.pengguna.list') }}" class="btn btn-danger btn-sm">&nbsp; Kembali</a>
