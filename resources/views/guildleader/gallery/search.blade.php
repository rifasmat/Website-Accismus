    ...
    <form action="{{ route('guildleader.gallery.search') }}" method="GET" class="form-inline mt-3">
        <div class="input-group">
            ...
            <div class="input-group-append">
                ...
                <a href="{{ route('guildleader.gallery.list') }}" class="btn btn-danger">Kembali</a>
            </div>
        </div>
    </form>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('guildleader.gallery.edit', $photo->gallery_uuid) }}" class="btn btn-warning btn-sm mr-1">Edit</a>

                            <form method="GET" action="{{ route('guildleader.gallery.konfirmasi', $photo->gallery_uuid) }}" style="display:inline;">
                                @csrf
