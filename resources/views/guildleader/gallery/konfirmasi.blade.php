...
<div class="container">
    ...
    <div>
        <a href="{{ route('guildleader.gallery.list') }}" class="btn btn-secondary btn-sm">Batal</a>
        <form method="POST" action="{{ route('guildleader.gallery.destroy', $gallery->gallery_uuid) }}" style="display:inline;">
            @csrf
            @method('DELETE')
