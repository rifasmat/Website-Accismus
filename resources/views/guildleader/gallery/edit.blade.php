...
<div class="container">
    <form action="{{ route('guildleader.gallery.update', $gallery->gallery_uuid) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mt-3">
            <a href="{{ route('guildleader.gallery.list') }}" class="btn btn-danger btn-sm">&nbsp; Kembali</a>
