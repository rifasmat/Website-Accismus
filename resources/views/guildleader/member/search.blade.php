            ...
            <tr class="text-center">
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('guildleader.member.edit', $user->uuid) }}" class="btn btn-warning btn-sm mr-1">Edit</a>
                        <form method="GET" action="{{ route('guildleader.member.konfirmasi', $user->uuid) }}" style="display:inline;">
