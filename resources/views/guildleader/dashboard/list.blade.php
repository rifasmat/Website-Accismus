...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('guildleader.dashboard.list') }}">Home</a></li>
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('guildleader.informasi.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Informasi -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('guildleader.about.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End About -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('guildleader.benefit.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Benefit -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('guildleader.team.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Team -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('guildleader.gallery.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Gallery -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('guildleader.broadcast.history') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Broadcast Email -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('guildleader.pengguna.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Pengguna -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('guildleader.member.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Member -->
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <a href="{{ route('guildleader.request-member.list') }}" class="btn btn-primary">Lihat</a>
        </div>
      </div>
    </div>
    <!-- End Guest -->
