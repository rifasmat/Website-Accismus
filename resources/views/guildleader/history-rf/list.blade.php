...
<div class="box-header d-flex justify-content-end mb-3">
    <div class="btn-group">
        <a href="{{ route('guildleader.history-rf.create') }}" class="btn btn-secondary">
...
<div class="container">
    <div class="mb-2">
        <!-- Search -->
        <form action="{{ route('guildleader.history-rf.search') }}" method="GET" class="form-inline mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('guildleader.history-rf.edit', $historyrf->history_uuid) }}" class="btn btn-warning btn-sm mr-1">Edit</a>

                            <form method="GET" action="{{ route('guildleader.history-rf.konfirmasi', $historyrf->history_uuid) }}" style="display:inline;">
                                @csrf
