...
<div class="container">
    <div class="mb-2">
        <!-- Search -->
        <form action="{{ route('guildleader.request-member.search') }}" method="GET" class="form-inline mt-3">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td>{{ $user->role }}</td>
                <td>
                    <img src="{{ Storage::url($user->foto) }}" alt="Foto Guest" class="img-thumbnail" style="width: 100px; height: 100px;">
                </td>
                <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <form action="{{ route('guildleader.request-member.changeStatus', $user->uuid) }}" method="POST" class="d-inline">
                            @csrf
                            @method('PATCH')
