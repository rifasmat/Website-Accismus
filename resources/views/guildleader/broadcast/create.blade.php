...
<form action="{{ route('guildleader.broadcast.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group mt-3">
        <a href="{{ route('guildleader.broadcast.history') }}" class="btn btn-danger btn-sm">&nbsp; Kembali</a>
