...
<div class="container">
    <form action="{{ route('guildleader.team.update', $user->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mt-3">
            <a href="{{ route('guildleader.team.list') }}" class="btn btn-danger btn-sm">&nbsp; Kembali</a>
