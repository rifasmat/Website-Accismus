...
<div class="container">
    <form action="{{ route('administrator.history-rf.update', $history->history_uuid) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mt-3">
            <a href="{{ route('administrator.history-rf.list') }}" class="btn btn-danger btn-sm">&nbsp; Kembali</a>
