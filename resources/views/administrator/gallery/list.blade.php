...
<div class="box-header d-flex justify-content-end mb-3">
    <div class="btn-group">
        <a href="{{ route('administrator.gallery.create') }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('administrator.gallery.edit', $galleries->gallery_uuid) }}" class="btn btn-warning btn-sm mr-1">Edit</a>

                            <form method="GET" action="{{ route('administrator.gallery.konfirmasi', $galleries->gallery_uuid) }}" style="display:inline;">
                                @csrf
