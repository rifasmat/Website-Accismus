...
<div class="container">
    ...
    <div>
        <a href="{{ route('administrator.gallery.list') }}" class="btn btn-secondary btn-sm">Batal</a>
        <form method="POST" action="{{ route('administrator.gallery.destroy', $gallery->gallery_uuid) }}" style="display:inline;">
            @csrf
            @method('DELETE')
