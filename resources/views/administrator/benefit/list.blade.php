...
<div class="container">
    <form action="{{ route('administrator.benefit.update', $benefit->benefit_uuid) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mt-3">
            <a href="{{ route('administrator.benefit.list') }}" class="btn btn-danger btn-sm">&nbsp; Kembali</a>
