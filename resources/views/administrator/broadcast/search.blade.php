...
<div class="container">
    <!-- Search -->
    <form action="{{ route('administrator.broadcast.search') }}" method="GET" class="form-inline mt-3">
        <div class="input-group">
            ...
            <div class="input-group-append">
                ...
                <a href="{{ route('administrator.broadcast.history') }}" class="btn btn-danger">Kembali</a>
            </div>
        </div>
    </form>
