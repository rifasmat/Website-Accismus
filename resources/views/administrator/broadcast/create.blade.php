...
<form action="{{ route('administrator.broadcast.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group mt-3">
        <a href="{{ route('administrator.broadcast.history') }}" class="btn btn-danger btn-sm">&nbsp; Kembali</a>
